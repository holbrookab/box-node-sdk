...
/**
 * Polls a representation until it the representation fails or is generated.
 *
 * API Endpoint: '/files/:fileID?fields=representations'
 * Method : GET
 *
 ...
 * @param {Function} [callback] - Passed a representaton objects if successful
 * @returns {Promise<Object>} A promise resolving to the representation response objects
*/
Files.prototype.pollRepresentationInfo = function(fileID, representationType, callback) {
...
Files.prototype.getRepresentationContent = function(fileID, representationType, options, callback) {
	...
	return this.getRepresentationInfo(fileID, representationType)
		...
		.then(repInfo => {
			var assetURLTemplate = repInfo.content.url_template;
